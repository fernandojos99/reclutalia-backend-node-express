...
export const SEED_CANDIDATOS: Candidato[] = [
  ...
  C(6, "Diego Ramírez Cline", "interno", "Datos y Analítica", "Analista de BI", "Semi-Senior", 4, "Licenciatura", "CDMX", "Híbrido", 28000, ["Business Intelligence"], ["SQL", "Power BI", "Tableau", "Excel avanzado"], ["Pensamiento analítico", "Gestión del tiempo"], "Colaborador interno del área de riesgos; automatizó el reporteo semanal de cartera."),
  ...
  C(9, "Lucía Herrera Bautista", "externo", "Tecnología", "Desarrolladora Frontend", "Semi-Senior", 4, "Licenciatura", "CDMX", "Híbrido", 34000, ["Desarrollo Frontend", "UX/UI"], ["React", "Figma", "Node.js"], ["Trabajo en equipo", "Atención al detalle", "Proactividad"], "SPAs bancarias con React; obsesionada con accesibilidad y design systems."),
  ...
  C(13, "Gabriela Fuentes Roldán", "externo", "Marketing", "Especialista en marketing digital", "Semi-Senior", 5, "Licenciatura", "CDMX", "Híbrido", 26000, ["Marketing Digital", "CRM y Fidelización"], ["Google Ads", "Meta Ads", "SEO", "CRM"], ["Creatividad", "Orientación a resultados", "Comunicación efectiva"], "Campañas performance con ROAS 6x en e-commerce; certificada Google."),
  ...
  C(15, "Renata Villaseñor Ochoa", "interno", "Marketing", "Analista de CRM", "Semi-Senior", 4, "Licenciatura", "CDMX", "Híbrido", 24000, ["CRM y Fidelización"], ["CRM", "SQL", "Excel avanzado"], ["Pensamiento analítico", "Atención al detalle"], "Journeys de retención y segmentación de clientes en el área de lealtad del grupo."),
  C(16, "Sebastián Cordero Lima", "externo", "Finanzas", "Analista financiero", "Semi-Senior", 5, "Licenciatura", "CDMX", "Presencial", 27000, ["Planeación Financiera"], ["Modelado financiero", "Excel avanzado", "SAP"], ["Pensamiento analítico", "Atención al detalle", "Gestión del tiempo"], "Presupuestos y forecast para grupo industrial; usuario avanzado de SAP FI."),
  ...
  C(19, "Camila Estrada Peralta", "externo", "Recursos Humanos", "Reclutadora IT", "Semi-Senior", 4, "Licenciatura", "Guadalajara", "Remoto", 22000, ["Atracción de Talento"], ["CRM", "Inglés avanzado"], ["Empatía", "Comunicación efectiva", "Negociación"], "Headhunting de perfiles tech; 90+ contrataciones cerradas en 2 años."),
  ...
  C(21, "Ximena Rosales Vidal", "interno", "Recursos Humanos", "Generalista de RRHH", "Semi-Senior", 5, "Licenciatura", "Monterrey", "Presencial", 21000, ["Atracción de Talento", "Capacitación"], ["Nómina", "Excel avanzado", "LMS"], ["Empatía", "Resolución de conflictos", "Trabajo en equipo"], "Generalista de planta con foco en clima laboral y onboarding."),
  C(22, "Bruno Cervantes Haro", "externo", "Operaciones", "Supervisor de logística", "Semi-Senior", 6, "Licenciatura", "León", "Presencial", 23000, ["Logística", "Cadena de Suministro"], ["SAP", "Excel avanzado"], ["Liderazgo", "Tolerancia a la presión", "Gestión del tiempo"], "CEDIS de 120 personas; redujo mermas 18% en un año."),
  ...
  C(26, "Iván Quintero Mora", "externo", "Atención a Clientes", "Coordinador de call center", "Semi-Senior", 6, "Licenciatura", "CDMX", "Presencial", 20000, ["Servicio al Cliente", "Cobranza"], ["Zendesk", "CRM", "Excel avanzado"], ["Liderazgo", "Tolerancia a la presión", "Empatía"], "Coordinó célula de 35 agentes bilingües; mejoró AHT 22%."),
  ...
  C(31, "Julieta Márquez Ferrer", "externo", "Tecnología", "Desarrolladora Frontend / UX", "Semi-Senior", 5, "Licenciatura", "CDMX", "Híbrido", 30000, ["Desarrollo Frontend", "UX/UI"], ["React", "Figma", "Node.js"], ["Creatividad", "Empatía", "Atención al detalle"], "Research y diseño de flujos transaccionales; sistema de diseño multi-marca."),
...
export const SEED_VACANTES: Vacante[] = [
  {
    ...
    req: crearRequisito({
      ...
      nivelPuesto: "Semi-Senior", anosExp: 3, espRequeridas: ["Servicio al Cliente"],
  ...
  },
  {
    ...
    req: crearRequisito({
      ...
      nivelPuesto: "Semi-Senior", anosExp: 4, espRequeridas: ["Servicio al Cliente", "Cobranza"],
  ...
  },
  {
    ...
    req: crearRequisito({
      ...
      nivelPuesto: "Semi-Senior", anosExp: 3, espRequeridas: ["Desarrollo Frontend"],
